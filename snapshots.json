...
<body class="auth-protected">
    ...
    <nav class="toolbar">
        <div class="range-tabs"><a class="nav-link" href="index.html">← Allianzstatistik</a><a class="nav-link" href="messages.html">Nachrichten</a><a class="nav-link" href="account.html">Imperiumsübersicht</a></div>
  ...
  <script src="player.js?v=8.7.0"></script>
</body>
